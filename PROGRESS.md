...
> 📅 最后更新：2026-06-29 23:20
> 🎯 目标：完成智能财务分析平台，用于大模型应用开发求职
> ✅ 里程碑1：RAG Pipeline 验证（比亚迪年报 290页 → 554块 → 检索问答）
> ✅ 里程碑2：Embedding 升级 + 混合检索（bge-base 768维 + BM25 + 语义 + RRF）
...
| RAG 文本分块 | ✅ 完成 | 财务文档专用（800/150） |
| RAG 向量化 | ✅ 完成 | bge-base-zh-v1.5 768维（升级） |
| RAG 向量存储 | ✅ 完成 | ChromaDB |
| RAG 混合检索 | ✅ 完成 | BM25 + 语义 + RRF 融合 |
| RAG Reranker | 🟡 下载中 | bge-reranker-v2-m3，当前自动回退 |
