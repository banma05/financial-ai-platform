...
| 12 | **RAG 评测体系重构** | **当前提交** | **撤 KW-R@5/MRR/NDCG，三指标对标 RAGAS（pro judge），answerable 分类，Agent 幻觉检测** |
...
| # | 事项 | 状态 |
|:--:|------|:--:|
| 12 | 评测体系重构 | 🟡 进行中（撤噪声指标 + 加生成质量） |
| 13 | Docker 构建验证 | ⬜ |
| 14 | 前端 SSE 浏览器验证 | ⬜ |

> 07-18 评测快照: Agent 100%/97.6%/97.3%/13.6s | RAG SEM-R@5 96.0%, 延迟~4s | 生成质量待跑 | 后端385+前端19全绿 | 成本 ¥0.70/15题
