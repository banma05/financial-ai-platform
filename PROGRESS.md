...
> 📅 最后更新：2026-07-18
> 🎯 当前版本：**V8.3 收尾中（11/12 完成）**
> 🏗️ 状态：剩 Docker 验证 / SSE 浏览器验证

---

## V8.3 最新评测基线 (07-18 下午)

| 指标 | V8.2 | V8.3 当前 | 目标 | 达标? |
|------|:--:|:--:|:--:|:--:|
| Agent 数字准确率 | 97.0% | **100.0%** | 98%+ | ✅ |
| Agent 现金流准确率 | 88.9% | **100.0%** | 95%+ | ✅ |
| Agent easy 准确率 | 91.1% | **100.0%** | 95%+ | ✅ |
| Agent 拆解准确率 | 97.6% | 97.6% | 85%+ | ✅ |
| Agent 平均耗时 | 13.8s | 13.6s | 30s | ✅ |
| RAG 语义召回 SEM-R@5 | 89.3% | **96.0%** | 90%+ | ✅ |
| RAG 关键词 KW-R@5 | N/A | 72.3% | 可用 | ✅ |
| RAG 平均检索耗时(全量) | 26.0s | **~4s** | 8s | ✅ |
| ChromaDB chunks | 3,042 | 5,097 | 5,000+ | ✅ |
| 后端测试 | 385 | 385 | 全绿 | ✅ |
| 前端测试 | 19 | 19 | 全绿 | ✅ |
...
> 07-18 下午评测快照: Agent 100%/97.6%/97.3%/13.6s | RAG SEM-R@5 96.0%, KW-R@5 72.3%, 延迟~4s | SQL 覆盖100% 准确95.8% | 后端385+前端19全绿 | 成本 ¥0.70/15题
