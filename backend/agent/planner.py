...
BUILTIN_TEMPLATES = {
    ...
    "valuation": {
        ...
        "tasks": [
            ...
            {"task_id": "5", "task_type": "chart",
             "description": "估值指标柱状图",
             "params": {"chart_type": "bar", "title": "{company} 估值指标"},
             "depends_on": ["3"]},
    ...
    "operating": {
        ...
        "tasks": [
            ...
            {"task_id": "5", "task_type": "chart",
             ...
             "params": {"chart_type": "bar", "title": "{company} 营运效率指标"},
             "depends_on": ["3"]},
            {"task_id": "6", "task_type": "analyze",
    ...
    "cost_analysis": {
        ...
        "tasks": [
            ...
            {"task_id": "4", "task_type": "chart",
             "description": "费用占比饼图",
             "params": {"chart_type": "pie", "title": "{company} 期间费用结构"},
             "depends_on": ["2"]},
            {"task_id": "5", "task_type": "analyze",
    ...
    "industry_compare": {
        ...
        "tasks": [
            ...
            {"task_id": "4", "task_type": "chart",
             ...
             "params": {"chart_type": "radar", "title": "{company} vs 行业均值"},
             "depends_on": ["2"]},
            {"task_id": "5", "task_type": "analyze",
